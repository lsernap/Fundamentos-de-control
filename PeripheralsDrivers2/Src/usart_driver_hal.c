...
static void usart_config_baudrate(USART_Handler_t *ptrUsartHandler){
	...
	switch(ptrUsartHandler->USART_Config.baudrate){
		...
		ptrUsartHandler->ptrUSARTx->BRR = 0x00683;
		}
		...
		ptrUsartHandler->ptrUSARTx->BRR = 0x00341;
			break;
		}
		...
		// Configurando el Baudrate generator para una velocidad de 19200bps
		ptrUsartHandler->ptrUSARTx->BRR = 0x001A1;
			break;
		}
...
//			// Como está activada, debemos configurar la interrupción por transmision
